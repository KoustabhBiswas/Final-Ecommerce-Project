		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="${pageContext.request.contextPath}"
					style="height: 59px">ShopMobiles</a>
			</div>
			<ul class="nav navbar-nav">

				<li class="dropdown"><a id="dropdown2"
					style="cursor: pointer;">Select Product <span
						class="caret"></span></a>
					<ul id="dropdown-menu1" >
						<li style="margin-left: -33%; margin-top: 8%;"><a href="${pageContext.request.contextPath}/samsung">Samsung</a></li>
						<li style="margin-left: -33%; margin-top: 10%;"><a href="${pageContext.request.contextPath}/nokia">Nokia</a></li>
						<!-- <li style="margin-left: -33%; margin-top: 10%;"><a href="#">HTC</a></li> -->
					</ul></li>
