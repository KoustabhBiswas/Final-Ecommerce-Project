...
.button {
 ...
 .newAddr{
	...
	border-radius:7px;
	box-shadow:2px 2px 4px grey, -1px -1px 6px grey;
	border-style:none;
	margin-bottom: 4%;
	margin-left:8%;
}
.newAddr:hover{
	box-shadow:1px 1px 2px grey, 2px 2px 4px grey;
} 
</style>
<body>
	<div class="container-fluid">
		...
		<div class="col-md-6"
			...
			<div id="form" style="display:none;">
				<form:form action="${pageContext.request.contextPath}/user/addAddress" method="post" modelAttribute="address" class="form-horizontal">
					<form:input path="shippingAddress" type="text" style="width : 200px;" class="form-control"/>
					<input type="submit" value="Add" class="newAddr" style="margin-left: 15%; margin-top: 2%;">
				</form:form>
				
			</div>
			 
				<button id="click" class="newAddr">Add New Address</button>
				</div>
		</div>
	</div>
</body>
